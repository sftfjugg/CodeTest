...
class WebRequest(object):
    ...
    def get(self, url, headers=None, retry_time=1, retry_interval=5, timeout=5, *args, **kwargs):
        """
        get method
    ...
    def post(self, url, headers=None, retry_time=1, retry_interval=5, timeout=5, *args, **kwargs):
        """
        post method
        :param url: target url
        :param header: headers
